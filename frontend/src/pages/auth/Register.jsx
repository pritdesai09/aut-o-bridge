      ...
      <div className="w-full max-w-md fade-in">
        <div className="glass rounded-3xl p-8 shadow-xl">
          <div className="text-center mb-8">
            <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-black text-2xl shadow-lg">A</div>
          ...
          <form onSubmit={submit} className="space-y-4">
            {[
              ...
              <div key={name}>
                ...
                <input type={type} name={name} value={form[name]} onChange={handle} required placeholder={placeholder}
            ...
            <button type="submit" disabled={loading}
              ...
              {loading ? <div className="animate-spin rounded-full h-5 w-5 border-2 border-white border-t-transparent"/> : <UserPlus className="w-5 h-5" />}
